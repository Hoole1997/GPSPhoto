...
val googleReleaseAabName = "lcb_gpsphoto_release_$resolvedVersionName.aab"
...
android {
    ...
    defaultConfig {
        ...
        // Google Maps SDK for Android key. Injected into the manifest as
        // com.google.android.geo.API_KEY. Only "Maps SDK for Android" needs to
        // be enabled for the map display, which has no per-load charge.
        manifestPlaceholders["MAPS_API_KEY"] = "AIzaSyC6O9_bEk6TU1LXqc69d2zoaXCfkBUdxrA"

        // Same key reused for the Street View Static Metadata API (free / no charge).
        // Requires "Street View Static API" enabled on the Cloud project.
        buildConfigField("String", "MAPS_API_KEY", "\"AIzaSyC6O9_bEk6TU1LXqc69d2zoaXCfkBUdxrA\"")

        // Mapillary API v4 client access token (free). Used for bbox street-view queries.
        buildConfigField(
            "String",
            "MAPILLARY_TOKEN",
            "\"MLY|27094691203491848|d59cdbe46060b618301ebad7d375a59e\""
        )
...
dependencies {
    ...
    // Google Maps + native fused location
    implementation("com.google.android.gms:play-services-maps:19.0.0")
    implementation("com.google.android.gms:play-services-location:21.3.0")
    // Marker clustering
    implementation("com.google.maps.android:android-maps-utils:3.8.2")

    // Coroutines for Street View metadata lookups
    implementation(libs.kotlinx.coroutines.android)

    // Bottom sheet list UI (high-de-style)
...
//    implementation(project(":core"))
    ...
    implementation("com.launcher.unity:com.gpsphoto.locationmap.tool-release:1.0.0")
}
